...
- We used **sklearn** training_ test_split method to split our data into training and testing sets.	
	...
	![](https://github.com/UTOR-VIRT-DATA-PT-10-2020-U-B-TEAM-5-FP/Final_Project/blob/kirti-segment-2/Resources/scaler_repeat_cust.png)
...
- #### **Description of how data was split into training and testing sets**
	...
	![](https://github.com/UTOR-VIRT-DATA-PT-10-2020-U-B-TEAM-5-FP/Final_Project/blob/kirti-segment-2/Resources/split_food.png)
	
	- Used **Standard scaler** to scale our training and testing data by fitting the scaler on training data set and use that transformed training and testing datasets for our machine learning model

	![](https://github.com/UTOR-VIRT-DATA-PT-10-2020-U-B-TEAM-5-FP/Final_Project/blob/kirti-segment-2/Resources/scaler_food.png)
- #### **Explanation of model choice, including limitations and benefits:**
...
- #### **Description of how data was split into training and testing sets**
	...
	![](https://github.com/UTOR-VIRT-DATA-PT-10-2020-U-B-TEAM-5-FP/Final_Project/blob/kirti-segment-2/Resources/split_drinks.png)
	
	- Used **Standard scaler** to scale our training and testing data by fitting the scaler on training data set and use that transformed training and testing datasets for our machine learning model

	
	![](https://github.com/UTOR-VIRT-DATA-PT-10-2020-U-B-TEAM-5-FP/Final_Project/blob/kirti-segment-2/Resources/scaler_drinks.png)
- #### **Explanation of model choice, including limitations and benefits:**
